 ...
 *
 * @author  MINPACK authors, The University of Chikago (1980-1999)
 ...
 * @param n [description]
 * @param r [description]
 * @param ldr [description]
 * @param ipvt [description]
 * @param diag [description]
 * @param qtb [description]
 * @param delta [description]
 * @param par [description]
 * @param x [description]
 * @param sdiag [description]
 * @param aux [description]
 * @param xdi [description]
 */
 ...
 * @param a [description]
 * @param ipvt [description]
 * @param rdiag [description]
 * @param acnorm [description]
 * @param wa [description]
 */
